...
procedure TOrganisasiItemFrm.CheckBox2Click(Sender: TObject);
begin
  if CheckBox2.Checked then
  begin
    KemasanFoto2Frm.QFoto.Close;
...
procedure TOrganisasiItemFrm.QSATUAN2NewRecord(DataSet: TDataSet);
begin
  QSATUAN2KD_SATUAN.AsString:=QMasterKD_SATUAN.AsString;
end;

procedure TOrganisasiItemFrm.TabSheet4Show(Sender: TObject);
begin
 vorder:='';
  QDetail2.Close;
  QDetail2.Open;
