object PindahLokasiFrm: TPindahLokasiFrm
        ...
        object PanelDetail: TPanel
          ...
          object LookItem: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              ...
              'SUB_LOKASI'#9'4'#9'LOKASI'#9'F'
              'JNS_KEMASAN'#9'10'#9'KEMASAN'#9'F'
              'QTY'#9'6'#9'QTY'#9'F')
            DataField = 'KD_ITEM'
            DataSource = dsQDetail
            LookupTable = QItem
  ...
  object QLokasi: TOracleDataSet
    SQL.Strings = (
        ...
        'asi b'
      'where a.kd_lokasi=b.kd_lokasi and jns_lokasi='#39'READY'#39
      ''
      ''
      '')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
        ...
        'select a.kd_item, a.nama_item, a.kd_satuan, d.satuan, b.kd_sub_l' +
        'okasi,'
      
        '      sum(b.qty_in-b.qty_out) as qty, b.no_lot, b.spinning, b.su' +
        'b_lokasi, b.jns_kemasan, sum(b.qty_in3-b.qty_out3) as qty_kemasa' +
        'n'
      
        '      from ipisma_db2.item a, ipisma_db2.gd_stok b, ipisma_db2.s' +
        'ub_lokasi c, ipisma_db2.satuan d'
      
        '      where a.kd_item=b.kd_item and b.kd_sub_lokasi=c.kd_sub_lok' +
        'asi and'
      '      a.kd_satuan=d.kd_satuan and c.jns_lokasi='#39'SEMENTARA'#39' and'
      '      b.tgl<=:tgl'
      
        '      group by a.kd_item, a.nama_item, a.kd_satuan, d.satuan, b.' +
        'kd_sub_lokasi, b.no_lot,b.spinning,b.sub_lokasi, b.jns_kemasan'
      '')
    Variables.Data = {
      0300000001000000040000003A54474C0C000000070000007875051301010100
      000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      
      00005154595F4B454D4153414E010000000000}
    ReadOnly = True
    QueryAllRecords = False
    ...
    object QItemQTY_KEMASAN: TFloatField
