...
procedure TSKSarongFrm.FormClose(Sender: TObject;
...
procedure TSKSarongFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TSKSarongFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TSKSarongFrm.LookKonstruksiEnter(Sender: TObject);
begin
  //DMFrm.QKonstruksi.Open;
end;

procedure TSKSarongFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TSKSarongFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
//  wwDBGrid2.SetFocus;
...
procedure TSKSarongFrm.wwDBGrid2Enter(Sender: TObject);
begin
...
procedure TSKSarongFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QSuplier.Close;
...
procedure TSKSarongFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
 if QTransaksiNO_NOTA.AsString<>'' then
  ...
  begin
      ...
      begin
          DMFrm.FNoUrut.Close;
          DMFrm.FNoUrut.SetVariable(0, '771');
...
procedure TSKSarongFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TSKSarongFrm.QTransaksiBeforeInsert(DataSet: TDataSet);
begin
...
procedure TSKSarongFrm.QTransaksiBeforeEdit(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TSKSarongFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QTransaksiNO_NOTA.AsString);
end;

procedure TSKSarongFrm.DBText2Click(Sender: TObject);
var
  vno_reg_cari : String;
begin
...
procedure TSKSarongFrm.BitBtn2Click(Sender: TObject);
begin
  rvdTTD.Execute;
end;

procedure TSKSarongFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TSKSarongFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TSKSarongFrm.ECariChange(Sender: TObject);
begin
...
procedure TSKSarongFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TSKSarongFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TSKSarongFrm.FormShow(Sender: TObject);
begin
...
procedure TSKSarongFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSKSarongFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  vnomer:=0;
...
procedure TSKSarongFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TSKSarongFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TSKSarongFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TSKSarongFrm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TSKSarongFrm.FormCloseQuery(Sender: TObject;
...
procedure TSKSarongFrm.QDetailBeforeInsert(DataSet: TDataSet);
begin
  if not vhak_input then
  begin
      ShowMessage('Maaf, Anda tidak berhak merubah data !');
...
procedure TSKSarongFrm.QTransaksiAfterDelete(DataSet: TDataSet);
begin
...
procedure TSKSarongFrm.DetailBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vrecord_ke);
end;

procedure TSKSarongFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TSKSarongFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TSKSarongFrm.RadioGroup1Click(Sender: TObject);
begin
  case RadioGroup1.ItemIndex of
  0 : vRecord.Value:=40;
  1 : vRecord.Value:=20;
...
procedure TSKSarongFrm.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vrecord_ke:=0;
end;

procedure TSKSarongFrm.wwDBGrid2DblClick(Sender: TObject);
var
...
procedure TSKSarongFrm.Button1Click(Sender: TObject);
begin
  wwDBGrid2DblClick(Nil);
end;

procedure TSKSarongFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TSKSarongFrm.BtnExportClick(Sender: TObject);
begin
{azmi}
  case PageControl1.ActivePageIndex of
  0 :
...
procedure TSKSarongFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TSKSarongFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TSKSarongFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSKSarongFrm.BtnFormulasiClick(Sender: TObject);
begin
...
procedure TSKSarongFrm.Label3Click(Sender: TObject);
begin
  {DMFrm.QSisdur.Close;
...
procedure TSKSarongFrm.LookSuplierCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
var
  vkota : string;
begin
...
procedure TSKSarongFrm.LookSuplierEnter(Sender: TObject);
begin
 QSuplier.close;
 QSuplier.Open;
end;

procedure TSKSarongFrm.LookSuplierUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QSuplier.Close;
  QSuplier.Open;
...
procedure TSKSarongFrm.LookMUEnter(Sender: TObject);
begin
  DMFrm.QMU.Open;
end;

procedure TSKSarongFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
//  QTotal.Close;
...
procedure TSKSarongFrm.QuickRep2BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  vdpp:=0;
  vppn:=0;
...
procedure TSKSarongFrm.PageHeaderBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vfirst_page:=False;
end;

procedure TSKSarongFrm.QBrowseDetailBeforeOpen(DataSet: TDataSet);
begin
//  QBrowseDetail.SetVariable('no_reg_po',QBrowseNO_REG_PO.AsInteger);
end;

procedure TSKSarongFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TSKSarongFrm.QSuplierBeforeOpen(DataSet: TDataSet);
begin
...
procedure TSKSarongFrm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inc(vnomer);
...
procedure TSKSarongFrm.BitBtn4Click(Sender: TObject);
begin
...
procedure TSKSarongFrm.wwDBDateTimePicker1Change(Sender: TObject);
begin
//btnformulasi.Click;
 { if QTransaksi.State<>dsBrowse then
   try
...
procedure TSKSarongFrm.QTransaksiAfterCancel(DataSet: TDataSet);
begin
wwDBDateTimePicker1.Enabled:=true;
end;

procedure TSKSarongFrm.Btn_filterClick(Sender: TObject);
...
procedure TSKSarongFrm.Vtglawal2Change(Sender: TObject);
begin
 vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));

end;

procedure TSKSarongFrm.Vtglakhir2Change(Sender: TObject);
begin
...
procedure TSKSarongFrm.dbcfield2Enter(Sender: TObject);
...
procedure TSKSarongFrm.cbotomatis2Click(Sender: TObject);
begin
...
procedure TSKSarongFrm.ecari2Change(Sender: TObject);
begin
  if cbOtomatis2.Checked then
  begin
...
procedure TSKSarongFrm.wwDBGrid3DblClick(Sender: TObject);
...
procedure TSKSarongFrm.wwDBGrid3TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
 if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TSKSarongFrm.Qbrowse2BeforeOpen(DataSet: TDataSet);
begin
// QBrowse2.SetVariable('kd_transaksi',QJnsTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSKSarongFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TSKSarongFrm.Voperand2Click(Sender: TObject);
begin
{azmi}
  if vOperand2.Caption='LIKE' then
    vOperand2.Caption:='='
...
procedure TSKSarongFrm.cbtanggal2Click(Sender: TObject);
begin
  if cbTanggal2.Checked then
  begin
...
procedure TSKSarongFrm.PageHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TSKSarongFrm.wwDBGrid4CalcCellColors(Sender: TObject;
  Field: TField; State: TGridDrawState; Highlight: Boolean; AFont: TFont;
  ABrush: TBrush);
begin
{  if not Highlight then
...
procedure TSKSarongFrm.wwDBGrid4DblClick(Sender: TObject);
var
  vnama_barang_org : String;
  vketerangan_org : String;
  vpos : Integer;
...
procedure TSKSarongFrm.wwDBGrid4Enter(Sender: TObject);
begin
  if QTransaksi.State<>dsBrowse then
        try
          QTransaksi.Post;
...
procedure TSKSarongFrm.LookSarongEnter(Sender: TObject);
begin
  QLookItem2.Close;
  QLookItem2.Open;
end;

procedure TSKSarongFrm.QDetailAfterQuery(Sender: TOracleDataSet);
begin
{  QDetailKD_ITEM2.AsString:=QDetailKD_ITEM.AsString;
  QDetailKD_proyek.AsString:=QDetailKETERANGAN.AsString;}
end;

procedure TSKSarongFrm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if QTransaksiISPOST.AsString='1' then
...
procedure TSKSarongFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TSKSarongFrm.LookSarongCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  QDetailNAMA_ITEM.AsString:=QLookItem2NAMA_ITEM.AsString;
end;

procedure TSKSarongFrm.LookSarongUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  QLookItem2.Close;
  QLookItem2.Open;
...
procedure TSKSarongFrm.wwDBComboBox1Change(Sender: TObject);
begin
  if QTransaksiPPN.AsString='0' then QTransaksiISPJK.AsString:='0' else QTransaksiISPJK.AsString:='1';
end;

procedure TSKSarongFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailPOT_HRG.AsFloat:=0;
end;

procedure TSKSarongFrm.QDetailQTYChange(Sender: TField);
var
...
procedure TSKSarongFrm.QDetailHRGChange(Sender: TField);
var
  vqty, vhrg, vpot : Double;
begin
  vqty:=QDetailQTY.AsFloat;
...
procedure TSKSarongFrm.QDetailPOT_HRGChange(Sender: TField);
var
  vqty, vhrg, vpot : Double;
begin
  vqty:=QDetailQTY.AsFloat;
